...
enum {
  ...
  sym_tag_definition = 13,
  sym_string_parameter = 14,
  sym_variable = 15,
  sym_name = 16,
  ...
  aux_sym_definitions_repeat1 = 21,
};
...
static uint16_t ts_parse_table[STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [6] = {
    ...
    [sym_junk_definition] = ACTIONS(19),
  ...
  [11] = {
    ...
    [aux_sym_source_file_repeat1] = STATE(11),
    [sym_variable] = STATE(6),
    [sym_junk_definition] = ACTIONS(33),
  ...
  [19] = {
    ...
    [sym_junk_definition] = ACTIONS(59),
    [anon_sym_POUND] = ACTIONS(5),
  },
  [20] = {
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.count = 1, .reusable = true}, REDUCE(sym_tag_definition, 2),
  [31] = {.count = 1, .reusable = true}, SHIFT(14),
  [33] = {.count = 2, .reusable = true}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(11),
  ...
  [49] = {.count = 1, .reusable = true}, REDUCE(sym_tag_definition, 3),
  ...
  [57] = {.count = 1, .reusable = true}, REDUCE(sym_definitions, 1),
  [59] = {.count = 1, .reusable = true}, SHIFT(22),
  [61] = {.count = 1, .reusable = true}, SHIFT(23),
  [63] = {.count = 1, .reusable = true}, REDUCE(sym_string_parameter, 3),
  [65] = {.count = 2, .reusable = true}, REDUCE(aux_sym_definitions_repeat1, 2), SHIFT_REPEAT(22),
  [68] = {.count = 2, .reusable = true}, REDUCE(aux_sym_definitions_repeat1, 2), SHIFT_REPEAT(2),
  [71] = {.count = 1, .reusable = true}, REDUCE(aux_sym_definitions_repeat1, 2),
  [73] = {.count = 1, .reusable = true}, REDUCE(sym_body, 3),
};
